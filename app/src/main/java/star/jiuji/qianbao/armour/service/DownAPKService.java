package star.jiuji.qianbao.armour.service;
        ...
        OkGo.<File>get(fileUrl).execute(new FileCallback(targetName, System.currentTimeMillis()+".apk") {
            ...
            public void onSuccess(Response<File> response) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    Uri fileUri = FileProvider.getUriForFile(DownAPKService.this,  App.getApplication().getPackageName() + ".provider", response.body());
