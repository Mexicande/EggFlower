    ...
    private void CleanAllData() {
        ...
        dialog.setListener(new TipandEditDialog.ITipEndEditDialogListener() {
            ...
            public void ClickRight() {
                ...
                startActivity(new Intent(SettingActivity.this, Login1Activity.class));
                dialog.dismiss();
            }
