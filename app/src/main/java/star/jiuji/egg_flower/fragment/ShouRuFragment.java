...
import star.jiuji.egg_flower.adapter.PopWindowAdapter;
...
import star.jiuji.egg_flower.activity.EditIncomeAndCostActivity;
...
public class ShouRuFragment extends BaseFragment implements View.OnClickListener, BGAOnItemChildClickListener, BGAOnRVItemClickListener, BGAOnRVItemLongClickListener {
    ...
    private void initAdapter() {
        ...
        View headView = View.inflate(getActivity(), R.layout.shouru_head, null);
    ...
    protected void receiveEvent(Event event) {
        switch (event.getCode()) {
            case C.EventCode.EditIncomeAndCostActivityToShouRuFragment:
                ShouRuModel model = (ShouRuModel) event.getData();
